...
public class MemoryUI : MonoBehaviour
{
    ...
    IEnumerator SmoothMove(Vector3 startPos, Vector3 endPos, float seconds) {
        ...
        while (t <= 1.0) {
            ...
            ImagesParent.GetComponent<RectTransform>().rect.position = Vector3.Lerp(startPos, endPos, Mathf.SmoothStep(0f, 1f, t));
    ...
    void moveImage(){
        ...
        Vector3 newPos = ImagesParent.transform.position - new Vector3((canvasWidth), 0);
        Debug.Log("MEMORY UI: ImagesParent.transform.position: " + ImagesParent.transform.position);
        Debug.Log("MEMORY UI: canvasWidth: " + canvasWidth);
        Debug.Log("MEMORY UI: newPos: " + newPos);
