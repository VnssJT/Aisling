...
public class Memory : Item
{
    ...
    public static UnityAction<MemoryManager.MemoryIndex> OnVideoOpened;
    public static UnityAction<MemoryManager.MemoryIndex> OnImagesOpened;
    ...
    public override void Use()
    {
        ...
        switch (memoryType)
        {
            case MemoryManager.MemoryType.VIDEO:
                ...
                OnVideoOpened?.Invoke(MemoryID);
                //MemoryUI.instance.displayVideoMemory(MemoryID);
                break;
            case MemoryManager.MemoryType.IMAGES:
                //Debug.Log("MEMORY Displaying images");
                //MemoryUI.instance.displayImages(MemoryID);
                OnImagesOpened?.Invoke(MemoryID);
                break;
            default:
                break;
        }
