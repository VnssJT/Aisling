...
using UnityEngine;
using MemoryManager.instance.MemoryIndex;
...
public class GameManager : MonoBehaviour
{
    ...
    void MemoryManager_OnGreenFound(){
        ...
        if(MemoryManager.instance.memoriesFound[MemoryManager.MemoryIndex.VIOLET] 
            && MemoryManager.instance.memoriesFound[MemoryManager.MemoryIndex.CYAN]){
