...
public class GameManager : MonoBehaviour
{
    ...
    void MemoryManager_OnGreenFound(){
        Debug.Log("GAME MANAGER: Green found");
        Debug.Log("GAME MANAGER: VIOLET found " + MemoryManager.instance.memoriesFound[(int) MemoryManager.MemoryIndex.VIOLET]);
        Debug.Log("GAME MANAGER: VIOLET found " + MemoryManager.instance.memoriesFound[(int) MemoryManager.MemoryIndex.CYAN]);
        ...
        if(MemoryManager.instance.memoriesFound[(int) MemoryManager.MemoryIndex.VIOLET] 
            && MemoryManager.instance.memoriesFound[(int) MemoryManager.MemoryIndex.CYAN]){
                ...
                // Trigger event that activates the puzzle 1
                Debug.Log("GAME MANAGER: activating puzzle 1");
            }
    }
