...
public class MemoryUI : MonoBehaviour
{
    ...
    public void OnPrevButtonPressed(){
        ...
        if(currentImageDisplayed > 0){
            ...
            Vector3 newPos = ImagesParent.transform.position new Vector3(960, ImagesParent.transform.position.y); // for some reason it's 960 i have no idea why
    ...
    public void OnNextButtonPressed(){
        if(currentImageDisplayed < ImagesParent.transform.childCount - 1){
            currentImageDisplayed++;
            Vector3 newPos = /*ImagesParent.transform.position*/  new Vector3(-960 * currentImageDisplayed, ImagesParent.transform.position.y); // for some reason it's 960 i have no idea why
            StartCoroutine(SmoothMove(ImagesParent.transform.position, newPos, easing));
        }
    }
