...
public class PlayerController : MonoBehaviour
{
    ...
    private void Start() {
        ...
        DialogueManager.onDialogueEnded += DialogueManager_OndialogueEnede;
    }
    ...
    public void Pause_Performed(InputAction.CallbackContext context){
        ...
        // Trigger event to open the inventory
        onInventoryPressed?.Invoke();            

    }

    public void Cancel_Performed(InputAction.CallbackContext context){
        //Debug.Log("CLOSE_PERFORMED: " + playerInput.currentActionMap);
        ...
        // Trigger event to close the inventory
        onInventoryPressed?.Invoke();  
    }
}
