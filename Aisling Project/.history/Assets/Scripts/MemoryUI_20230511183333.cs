...
public class MemoryUI : MonoBehaviour
{
    ...
    public void OnPrevButtonPressed(){
        ...
        if(currentImageDisplayed > 0){
            ...
            Vector3 newPos = /*ImagesParent.transform.position*/ new Vector3(960 * currentImageDisplayed, ImagesParent.transform.position); // for some reason it's 960 i have no idea why
