...
public class PlayerController : MonoBehaviour
{
    ...
    private void Awake() {
        ...
        playerInputActions.Player.Ineteract.started += Interact_performed;
        playerInputActions.Player.Ineteract.performed += Interact_canceled;
