...
public class PlayerController : MonoBehaviour
{
    ...
    private void Update(){
        ...
        RaycastHit hit;
        bool active = Physics.Raycast(transform.position, transform.forward, out hit, playerActiveDistance);

        if(active){
             = hit.transform.TryGetComponent<InteractiveObject>(InteractiveObject interactiveObject);
        }
    }
}
