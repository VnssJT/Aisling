...
public class PlayerController : MonoBehaviour
{
    ...
    private void Update(){
        ...
        Vector3 raycastOrigin = transform.position - new Vector3(0, 0.5, 0);
        RaycastHit hit;
        bool active = Physics.Raycast(raycastOrigin, transform.forward, out hit, playerActiveDistance, 6);
