...
public class _CardGameManager : MonoBehaviour
{
    ...
    // EVENTS
    public delegate void OnMemoryMatch();
    public static OnMemoryMatch onMemoryMatchWon;
    ...
    void Start()
    {
        GameManager.onSecondPuzzleTriggered += onSecondPuzzledTrigger_StartCardGame;
        gameStart = false;
    ...
    void onSecondPuzzledTrigger_StartCardGame()
    {
